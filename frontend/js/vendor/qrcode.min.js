 ...
 *
 * Vendored rather than loaded from a CDN. This script runs on the device-pairing
 * screen, which handles single-use credentials, and a third-party origin able to
 * change that code at will could read them. Served from our own origin it is also
 * covered by the site's existing CSP with no script-src exception.
 */
