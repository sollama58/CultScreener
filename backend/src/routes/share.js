...
const THEMES = {
  default: {
    bg: '#09090b', accent: '#ff5722', secondary: '#ff8c00',
    textPrimary: '#f0f0f2', textSecondary: '#6b6b74',
    glowColor: 'rgba(255,87,34,0.04)',
  },
  cyber: {
    bg: '#050505', accent: '#00f2ff', secondary: '#ff00ff',
    textPrimary: '#ffffff', textSecondary: '#6b6b74',
    glowColor: 'rgba(0,242,255,0.08)',
  },
  emerald: {
    bg: '#060a09', accent: '#10b981', secondary: '#34d399',
    textPrimary: '#f0f0f2', textSecondary: '#6b6b74',
...
function generateTokenSvg(token, mint, theme = 'default') {
  ...
  <rect x="1" y="1" width="1198" height="628" rx="16" ry="16" fill="none" stroke="${t.glowColor}" stroke-width="1"/>
  ...
  <text x="52" y="50" font-family="Inter,-apple-system,BlinkMacSystemFont,sans-serif" font-size="22" font-weight="800" fill="${t.textPrimary}">Cult<tspan fill="${t.accent}">Screener</tspan></text>
  <g transform="translate(230, 28) scale(0.85)">
    <path d="M12 23c-4.97 0-8-3.03-8-7 0-2.22.98-4.12 2.5-5.5C5.5 8 5 5.5 7 3c1 2 3 3.5 5 4 0-2 1-4 3-6 .5 2 1 4 1 6 2-1 3.5-2.5 4-4 0 3-1 5.5-2.5 7.5C19.02 11.88 20 13.78 20 16c0 3.97-3.03 7-8 7z" fill="${t.accent}"/>
  </g>
  ...
  ${symbol ? `<text x="52" y="190" font-family="Inter,-apple-system,sans-serif" font-size="20" font-weight="500" fill="${t.textSecondary}">${symbol} · ${mintShort}</text>` : `<text x="52" y="190" font-family="'JetBrains Mono',monospace" font-size="18" fill="${t.textSecondary}">${mintShort}</text>`}
  ...
  <text x="52" y="400" font-family="Inter,-apple-system,sans-serif" font-size="13" font-weight="600" fill="${t.textSecondary}" text-transform="uppercase" letter-spacing="1">MARKET CAP</text>
  <text x="52" y="430" font-family="Inter,-apple-system,sans-serif" font-size="28" font-weight="700" fill="${t.textPrimary}">${esc(mcap)}</text>
  ...
  <text x="340" y="430" font-family="Inter,-apple-system,sans-serif" font-size="28" font-weight="700" fill="${t.textPrimary}">${esc(holdersStr)}</text>
  ...
  <rect x="620" y="448" width="${Math.round(convBarWidth * 5.3)}" height="10" rx="5" fill="url(#convGrad)"/>

  <line x1="40" y1="545" x2="1160" y2="545" stroke="rgba(255,255,255,0.04)" stroke-width="1"/>
  <text x="52" y="580" font-family="Inter,-apple-system,sans-serif" font-size="16" font-weight="600" fill="${t.textSecondary}">cultscreener.com</text>
  <text x="1148" y="580" font-family="Inter,-apple-system,sans-serif" font-size="14" font-weight="500" fill="${t.textSecondary}" text-anchor="end">Powered by ASDFASDFA</text>
...
/**
 * GET /share/:mint
 * OG meta tags for social media crawlers. Browsers get redirected.
 */
...
/**
 * GET /share/:mint/og-image — dynamic SVG (Discord, Telegram, Facebook)
 */
...
/**
 * GET /share/:mint/twitter-image.png — dynamic PNG for X (SVG not supported)
 */
