...
function generateTokenSvg(token, mint) {
  ...
  <text x="1148" y="48" font-family="Inter,-apple-system,sans-serif" font-size="14" font-weight="500" fill="#6b6b74" text-anchor="end">Diamond Hands Terminal</text>
  ...
  <!-- Stats row -->
  <!-- MCap -->
  <text x="52" y="400" font-family="Inter,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#6b6b74" text-transform="uppercase" letter-spacing="1">MARKET CAP</text>
  <text x="52" y="430" font-family="Inter,-apple-system,sans-serif" font-size="28" font-weight="700" fill="#a0a0a8">${esc(mcap)}</text>

  <!-- Holders -->
  <text x="340" y="400" font-family="Inter,-apple-system,sans-serif" font-size="13" font-weight="600" fill="#6b6b74" letter-spacing="1">HOLDERS</text>
